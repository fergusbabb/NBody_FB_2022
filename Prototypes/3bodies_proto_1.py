...
def nextvals(pos, vel, mass, acc):
    
    return nextpos, nextvel, nextacc
...
while t <= tmax:
    canvas.cla()
    # (1/2) kick
    a12, a21 = accel(pos[0,:],pos[1,:], m1, m2)
    a13, a31 = accel(pos[0,:],pos[2,:], m1, m3)
    a23, a32 = accel(pos[1,:],pos[2,:], m2, m3)
    a1 = a12 + a13
    a2 = a21 + a23
    a3 = a31 + a32

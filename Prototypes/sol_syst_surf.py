...
xt = np.linspace(-AU, AU, pts)
yt = np.linspace(-AU, AU, pts)
...
zmin = -20*G*Msun/Rsun #Potential at r = Rsun/20
...
surfax.contour(xt, yt, -np.log2(-Usurf), levels = 20, cmap = cm.RdPu)
surfax.set_xlim(-AU, AU)
surfax.set_ylim(-AU, AU)

#______________________________Initialize Plots________________________________


sizes = [5, 2, 1]
clrs  = ['gold', 'turquoise', 'white'] 

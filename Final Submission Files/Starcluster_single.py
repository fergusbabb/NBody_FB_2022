...
#__________________________Code for N normal bodies____________________________
...
#Define location of BHs to be at center of cluster
x0[0] = locx1
y0[0] = locy1

#Define initial velocities to <=> KE equal to U/2 
...
#Position BHs and adjust locations
vx0[0], vy0[0]  =  0, 0
vx0[1:N]+=vx0[0]
vy0[1:N]+=vy0[0] #To make the bodies orbit their BH

#Define array for ODE
...
def ode(init, time, masses, G, off, size, d):
    ...
    #*0.999 to simulate very small energy losses

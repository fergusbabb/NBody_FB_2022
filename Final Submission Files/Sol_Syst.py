...
off = AU/1000 #small number to avoid division by 0
c = 299792458 #m/s
...
#make smaller plot with terrestrial planets and larger plot with all planets
for p in range(0,5):
...
#______________________________Initialise animation____________________________
